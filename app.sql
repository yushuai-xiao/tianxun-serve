...
Source Server         : qq_server
Source Server Version : 50726
Source Host           : 47.102.109.7:3306
...
CREATE TABLE `buy_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `record_user_ref` (`user_id`),
  KEY `record_prod_ref` (`product_id`),
...
CREATE TABLE `department` (
  ...
  `super_id` int(10) unsigned DEFAULT NULL COMMENT '父级部门',
  `introduction` varchar(200) DEFAULT NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_modify_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dep_super_dep_ref` (`super_id`),
  KEY `dep_leader_ref` (`leader`),
...
-- ----------------------------
INSERT INTO `department` VALUES ('1001', '光明帝国', 'zbd', null, null, '2021-12-19 16:54:34', '2021-12-19 16:54:34');
INSERT INTO `department` VALUES ('1002', '黑暗教廷', 'root', null, null, '2021-12-19 17:04:49', '2021-12-19 17:04:49');
INSERT INTO `department` VALUES ('1003', 'ag', 'xs', null, null, '2021-12-19 17:08:13', '2021-12-19 17:08:13');
INSERT INTO `department` VALUES ('1004', '我没有名字', null, null, null, '2021-12-19 17:08:52', '2021-12-19 17:08:52');
...
CREATE TABLE `permission` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb4 DEFAULT '' COMMENT '菜单名称',
  `superId` int(10) unsigned DEFAULT NULL COMMENT '父级菜单ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_modify_time` datetime NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `super_menu_ref` (`superId`),
  CONSTRAINT `super_menu_ref` FOREIGN KEY (`superId`) REFERENCES `permission` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=30205 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of permission
-- ----------------------------
INSERT INTO `permission` VALUES ('1', '/main/analysis', null, '系统总览', null, '2021-12-15 21:14:06', '2021-12-15 21:14:08', '1');
INSERT INTO `permission` VALUES ('2', '/main/system', null, '系统管理', null, '2021-12-15 21:16:27', '2021-12-15 21:16:27', '1');
INSERT INTO `permission` VALUES ('3', '/main/product', null, '商品中心', null, '2021-12-15 21:17:42', '2021-12-15 21:17:42', '1');
INSERT INTO `permission` VALUES ('4', '/main/story', null, '随便聊聊', null, '2021-12-15 21:18:07', '2021-12-15 21:18:07', '1');
INSERT INTO `permission` VALUES ('101', '/main/analysis/overview', null, '核心技术', '1', '2021-12-15 21:19:14', '2021-12-15 21:19:14', '1');
INSERT INTO `permission` VALUES ('102', '/main/analysis/dashboard', null, '商品统计', '1', '2021-12-15 21:19:55', '2021-12-15 21:19:55', '1');
INSERT INTO `permission` VALUES ('201', '/main/system/user', null, '用户管理', '2', '2021-12-15 21:21:07', '2021-12-15 21:21:07', '1');
INSERT INTO `permission` VALUES ('202', '/main/system/department', null, '部门管理', '2', '2021-12-15 21:22:00', '2021-12-15 21:22:00', '1');
INSERT INTO `permission` VALUES ('203', '/main/system/menu', null, '菜单管理', '2', '2021-12-15 21:23:05', '2021-12-15 21:23:05', '1');
INSERT INTO `permission` VALUES ('204', '/main/system/role', null, '角色管理', '2', '2021-12-15 21:23:40', '2021-12-15 21:23:40', '1');
INSERT INTO `permission` VALUES ('301', '/main/product/category', null, '商品类别', '3', '2021-12-15 21:24:21', '2021-12-15 21:24:21', '1');
INSERT INTO `permission` VALUES ('302', '/main/product/goods', null, '商品信息', '3', '2021-12-15 21:25:15', '2021-12-15 21:25:15', '1');
INSERT INTO `permission` VALUES ('401', '/main/story/chat', null, '随便聊聊', '4', '2021-12-15 21:25:54', '2021-12-15 21:25:54', '1');
INSERT INTO `permission` VALUES ('402', '/main/story/list', null, '故事列表', '4', '2021-12-15 21:26:14', '2021-12-15 21:26:14', '1');
...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`id`),
  KEY `prod_categroy_ref` (`category`),
...
INSERT INTO `product` VALUES ('16', '2018秋装新款韩版宽松针织开衫毛衣外套上衣女修身显瘦吊带连衣裙两件套学生裙子时尚套装', '2018秋装新款韩版宽松针织开衫毛衣外套上衣女修身显瘦吊带连衣裙两件套学生裙子时尚套装', '99.00', '69.00', 'http://s3.mogucdn.com/mlcdn/c45406/180901_4lc505f9hgb86106k8cjcljj25294_640x960.jpg_560x999.jpg', '1', '2021-12-18 14:27:29', '2021-12-18 14:27:29', '5');
...
CREATE TABLE `product_collection` (
  ...
  KEY `coll_prod_ref` (`product_id`),
  CONSTRAINT `coll_prod_ref` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON UPDATE CASCADE,
...
CREATE TABLE `role` (
  ...
  `introduction` varchar(100) DEFAULT '' COMMENT '角色简介',
  `permissions` varchar(300) DEFAULT '' COMMENT '角色拥有的权限',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_modify_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`symbol`)
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '信息浏览者', '仅拥有所有查看权限', '1,2,3,4,101,102,20104,20204,20304,20404,30104,30204', '2021-12-18 15:05:38', '2021-12-18 15:05:38');
INSERT INTO `role` VALUES ('2', '超级管理员', '至高无上的神啊!', '1,2,3,4,101,102,201,202,203,204,301,302,401,402,20101,20102,20103,20104,20201,20202,20203,20204,20303,20304,20401,20402,20403,20404,30101,30102,30103,30104,30201,30202,30203,30204', '2021-12-16 17:00:45', '2021-12-17 17:00:30');
INSERT INTO `role` VALUES ('3', 'root', '', '1,2,3,4,20101,201', '2021-12-17 17:41:12', '2021-12-17 17:41:12');
INSERT INTO `role` VALUES ('4', 'cd', 'cd', '1,101,102,103,104', '2021-12-17 23:21:23', '2021-12-17 23:21:23');
INSERT INTO `role` VALUES ('5', 'root', '', '1,2,3,4,20101,1', '2021-12-19 16:08:11', '2021-12-19 16:08:11');
INSERT INTO `role` VALUES ('6', '', '', '2,3,4', '2021-12-19 17:42:03', '2021-12-19 17:42:03');
INSERT INTO `role` VALUES ('7', '', '', '1,2,3', '2021-12-19 18:12:57', '2021-12-19 18:12:57');
INSERT INTO `role` VALUES ('8', 'test', 'test', '201,2,3', '2021-12-19 18:18:55', '2021-12-19 18:18:55');
...
CREATE TABLE `user` (
  ...
  `last_modify_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_role_ref` (`role_id`),
  KEY `user_dep_ref` (`department_id`),
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('22445', null, '超级管理员', '12355', '1003', '1', null, null, null, '1', null, '2021-12-18 22:43:03', '2021-12-18 22:43:20');
...
INSERT INTO `user` VALUES ('xs', '', 'coderxs', '723329', '1003', '1', '2', 'xs', '17548567849', '1', null, '2021-12-14 14:23:23', '2021-12-16 22:32:28');
INSERT INTO `user` VALUES ('xsxs', null, 'xsxs', 'xsxsxss', null, '1', '1', 'xsxs', 'xsxsxsx', '1', null, '2021-12-18 22:43:36', '2021-12-18 22:43:36');
INSERT INTO `user` VALUES ('yushusixs', null, 'yushus', 'xddfgdfdf', null, '1', '1', 'fdfdfdf', '488484', '1', null, '2021-12-18 22:45:08', '2021-12-18 22:48:10');
...
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `trig_permissions_before_insert`;
DELIMITER ;;
CREATE TRIGGER `trig_permissions_before_insert` BEFORE INSERT ON `role` FOR EACH ROW BEGIN
  declare i, max int(3) default 1;
  declare len1, len2 int(3) default 0;
  declare temp_permission varchar(100) default '1';
  declare flag int(3) default 0;
  set NEW.permissions = replace(NEW.permissions, ' ', '');
  set len1 = length(NEW.permissions);
  # 将 , 换为 空字符
  set len2 = length(replace(NEW.permissions, ',', ''));
  set max = len1 - len2 + 1;
  task: loop
    set temp_permission = substring_index(substring_index(NEW.permissions, ',', i),',',-1);
    select count(id) into flag from permission where id = replace(temp_permission,' ', '') + 0;
    if (flag != 1) then
      insert into error_tool value(null);
      leave task;
    end if;
...
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `trig_permissions_before_update`;
DELIMITER ;;
CREATE TRIGGER `trig_permissions_before_update` BEFORE UPDATE ON `role` FOR EACH ROW BEGIN
  declare i, max int(3) default 1;
  declare len1, len2 int(3) default 0;
  declare temp_permission varchar(100) default '1';
  declare flag int(3) default 0;
